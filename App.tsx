...
import {SettingsProvider} from 'src/shared/providers/settingsProvider/settings.provider'
    ...
    return (
        <Provider store={store}>
            <ThemeProvider initial={theme}>
                <SafeAreaProvider style={{backgroundColor: appTheme.theme.color.background}}>
                    <NavigationContainer>
                        <MyRealmProvider>
                            <IsLoadingProvider>
                                <SettingsProvider>
