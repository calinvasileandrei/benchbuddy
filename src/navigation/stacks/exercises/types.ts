...
export type ExerciseRouteProp<T extends keyof ExercisesStackParamList> = RouteProp<
    ExercisesStackParamList,
    T
>
export type ExerciseNavigationProp<T extends keyof ExercisesStackParamList> = StackNavigationProp<
    ExercisesStackParamList,
    T
>
