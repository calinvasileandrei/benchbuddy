...
export type WorkoutStackParamList = {
    ...
    [AppRoutes.EXERCISES_SELECTION_SCREEN]: {
        setExercises: (exercises: ExerciseModel) => void
    }
}

export type WorkoutRouteProp<T extends keyof WorkoutStackParamList> = RouteProp<
    WorkoutStackParamList,
    T
>
export type WorkoutNavigationProp<T extends keyof WorkoutStackParamList> = StackNavigationProp<
    WorkoutStackParamList,
    T
>
