...
import {
    WorkoutSessionCreationScreen
} from 'src/screens/app/workout/screens/workoutSessionCreation/workoutSessionCreation.screen';
...
} from 'src/screens/app/workout/screens/workoutSessionDetails/workoutSessionDetails.screen';
...
import {
    workoutSessionInfiniteListActions
} from 'src/store/workoutSessionInfiniteList/workoutSessionInfiniteList.actions';
...
export const WorkoutStack = () => {
    ...
    const getWorkoutSessionCreationOptions = (title: string): StackNavigationOptions => {
        ...
        return {
            ...getOptions(title),
            headerRight: () => <MenuMoreButton options={[
                {
            ...
            headerRight: () => <MenuMoreButton options={[
                {
                    ...
                    onPress: () => navigation.navigate(AppRoutes.WORKOUT_EDIT_SCREEN)
                },
                {title: 'Delete', iconName: 'trash-outline', onPress: () => handleDelete()}
            ]}/>
        }
    }

    const getWorkoutSessionDetailOptions = (title: string): StackNavigationOptions => {
        ...
        const handleDelete = async () => {
            if (workoutSession) {
                ...
                await workoutSessionsService.deleteWorkoutSession(workoutSession.id)
                // Delete the session id from the user
                await UserWorkoutService.deleteUserSessionWorkout(workoutSession.id)
                // Delete the session Hit from typesense
                await workoutSessionTypesenseService.deleteWorkoutSession(workoutSession.id)
        ...
        return {
            ...getOptions(title),
            headerRight: () => <MenuMoreButton options={[
                {title: 'Edit', iconName: 'create-outline', onPress: () => handleEdit()},
                {title: 'Delete', iconName: 'trash-outline', onPress: () => handleDelete()}
            ]}/>
        }
    }

    const getWorkoutSessionEditOptions = (title: string): StackNavigationOptions => {
        return {
            ...getOptions(title),
        }
    }
    ...
    const getWorkoutCreationOptions = (title: string): StackNavigationOptions => {
        return {
            ...getOptions(title),
        }
    }
    return (
        <Stack.Navigator screenOptions={{headerShown: false}}>
            <Stack.Screen name={AppRoutes.WORKOUTS_SCREEN} component={WorkoutScreen}/>

            <Stack.Screen name={AppRoutes.WORKOUT_DETAIL_SCREEN}
                          options={getWorkoutDetailOptions('Workout Details')}
                          component={WorkoutDetailScreen}/>

            <Stack.Screen name={AppRoutes.WORKOUT_EDIT_SCREEN}
                          options={getOptions('Workout Edit')}
                          component={WorkoutEditScreen}/>

            <Stack.Screen name={AppRoutes.WORKOUT_CREATION_SCREEN}
                          options={getWorkoutCreationOptions('Workout Creation')}
                          component={WorkoutCreationScreen}/>

            <Stack.Screen name={AppRoutes.WORKOUT_SESSION_CREATION_SCREEN}
                          options={getWorkoutSessionCreationOptions('Workout Session Creation')}
                          component={WorkoutSessionCreationScreen}/>

            <Stack.Screen name={AppRoutes.WORKOUT_SELECTION_SCREEN}
                          options={getModalOptions('Your Workouts')}
                          component={WorkoutSelectionScreen}/>

            <Stack.Screen name={AppRoutes.WORKOUT_SESSION_DETAILS}
                          options={getWorkoutSessionDetailOptions('Workout Session Details')}
                          component={WorkoutSessionDetailsScreen}/>

            <Stack.Screen name={AppRoutes.WORKOUT_SESSION_EDIT}
                          options={getWorkoutSessionEditOptions('Workout Session Edit')}
                          component={WorkoutSessionEditScreen}/>

            <Stack.Screen name={AppRoutes.EXERCISES_SELECTION_SCREEN}
