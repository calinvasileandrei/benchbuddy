...
export type AccountRouteProp<T extends keyof AccountStackParamList> = RouteProp<AccountStackParamList, T>
export type AccountNavigationProp<T extends keyof AccountStackParamList> = StackNavigationProp<AccountStackParamList, T>
