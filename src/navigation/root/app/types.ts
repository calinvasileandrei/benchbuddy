...
export type AppScreenProps<T extends keyof AppParamList> = CompositeScreenProps<BottomTabScreenProps<AppParamList, T>, RootStackScreenProps<keyof RootStackParamList>>
