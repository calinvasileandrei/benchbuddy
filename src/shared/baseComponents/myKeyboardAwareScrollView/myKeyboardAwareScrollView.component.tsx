...
import {myKeyboardAwareScrollViewStyle} from 'src/shared/baseComponents/myKeyboardAwareScrollView/myKeyboardAwareScrollView.style';
...
export const MyKeyboardAwareScrollView: FC<
    MyKeyboardAwareScrollViewProps
> = props => {
