...
import {typesenseInfiniteListStyle} from 'src/shared/advancedComponents/typesenseInfiniteList/typesenseInfiniteList.style';
...
export const TypesenseInfiniteList = <T extends unknown>(
    props: TypesenseInfiniteListProps<T>,
) => {
