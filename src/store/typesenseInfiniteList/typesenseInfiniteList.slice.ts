...
export const typesenseInfiniteListSlice = createSlice({
    ...
    reducers: {
        ...
        setFilterBy: (
            state,
            action: PayloadAction<FilterObject[] | undefined>,
        ) => {
    ...
    extraReducers: builder => {
        builder.addCase(
            typesenseInfiniteListActions.fetchData().pending,
            (state, action) => {
                state.isLoading = true;
            },
        );
        builder.addCase(
            typesenseInfiniteListActions.fetchData().fulfilled,
            (state, action) => {
...
export const typesenseInfiniteListSliceActions =
    typesenseInfiniteListSlice.actions;
