    ...
    reducers: {
        initSession: (state, action: PayloadAction<WorkoutModel>) => {
            ...
            state.workoutSession = {
                ...
                duration: '0',
                createdAt: dateUtils.getDateToMilliseconds(state.createdAt.toDateString())
            }
        },
        ...
        saveExerciseSet: (
            ...
            if (state.workoutSession) {
                ...
                const index = state.workoutSession?.sessionExercises.findIndex(
                    exerciseWorkout => exerciseWorkout?._id === sessionExerciseId
                )
                if (index === -1) {
                ...
                const exercisesWorkout = state.workoutSession?.sessionExercises
