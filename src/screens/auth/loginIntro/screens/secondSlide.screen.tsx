    ...
    return (
        <View key={'secondSlide'} style={style.container}>
            ...
            <View style={style.bottomContainer}>
                <MyText style={style.logoText}>Transform Your Training 🏋️‍♀️</MyText>
                <LeftMessageComponent text={'Improve with easy-to-understand metrics'} />
                <RightMessageComponent
                    text={'Use Artificial Intelligence to check your exercises form'}
                />
