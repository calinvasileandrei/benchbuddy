...
export const WorkoutQuickLook: FC<WorkoutQuickLookProps> = () => {
    ...
    const handleCreateWorkout = () => {
        ...
        navigation.navigate(AppRoutes.WORKOUTS_STACK,{screen: AppRoutes.WORKOUT_CREATION_SCREEN})
    }
    ...
    return (
        <MyCard>
            <View style={style.iconContainer}>
                ...
                <MyIcon size={30} onPress={handleCreateWorkout} withHaptics={'impactMedium'} iconName='add-circle'/>
            </View>
        </MyCard>
    );
};
