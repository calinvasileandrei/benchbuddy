...
export const QuickStart: FC<QuickStartProps> = (props) => {
    ...
    const {quickStartContainerStyle, myAnimatedContainer, iconStyle, handleToggleMenu} = useQuickStartAnimations()

    const handleLogWorkoutSession = () => {
        console.log('handleCreateWorkoutSession')
        handleToggleMenu()
        navigation.navigate(AppRoutes.WORKOUTS_STACK, {screen: AppRoutes.WORKOUT_SESSION_CREATION_SCREEN})
    }
...
{/*            <View style={style.iconContainer}>
            ...
            <View style={{
                ...
                <MyIcon size={30} onPress={handleLogWorkoutSession} iconName="add-circle"/>
            </View>
        </MyCard>
